...
| **`track:workforce`** | `scripts/workforce/` · `workforce/` (raw + DuckDB store, both gitignored) · `docs/workforce/` · `docs/plans/2026-04-29-ap-rw-phase1-plan.md` · `wf.py` CLI (read-only against static pack in Phase 1)                                                                                                                                                                                                                                                                                                                                                                                    | `scripts/alerts.py` · `brief.py` · `agent.py` · `cockpit.py` · `eval/` · `sf_dashboard/cockpit/` · `scripts/sf_audit/` · `docs/sf_audit/` · the live SF org (Phase 1 is read-only against the static pack only) |
