#!/usr/bin/env python3
"""Run the BainToolbox programmatic tour probe on the Windows VM.

Creates a transient PowerPoint deck, places shapes, calls
BainToolboxRectangles + BainToolboxApplyShift, observes position changes.
Closes deck without saving. Does NOT touch SimCorp assets.
"""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_bain_toolbox_tour.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / "bain_toolbox_tour"
            / stamp
            / "thinkcell_bain_toolbox_tour_probe.json"
        )
