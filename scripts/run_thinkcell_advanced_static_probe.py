#!/usr/bin/env python3
"""Run advanced static PS probe on Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_advanced_static.ps1"
...
def main():
    ...
    ps = "\n".join(
        [
            ...
            f'& "{_to_unc(PROBE_PS1)}" -OutputPath "{_to_unc(out)}"',
        ]
    )
