#!/usr/bin/env python3
"""Run the LoadStyleForRegion per-region styling probe on the Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_per_region_style.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / "per_region_style"
            / stamp
            / "thinkcell_per_region_style_probe.json"
        )
