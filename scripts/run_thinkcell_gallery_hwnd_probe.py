#!/usr/bin/env python3
"""Run the ShowChartGallery HWND parameter probe on the Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_gallery_hwnd.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / "gallery_hwnd"
            / stamp
            / "thinkcell_gallery_hwnd_probe.json"
        )
