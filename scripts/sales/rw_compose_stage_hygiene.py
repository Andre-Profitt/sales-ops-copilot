...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        _stage_card("f_stage_transition", "Stage Forward Pct (LE)", "Forward rate", x=40, y=104, w=216, h=76, tint="#EEF9EE", accent="#3B8A3E", value_color="#1F6F3B"),
        _stage_card("f_stage_transition", "Stage Backward Pct (LE)", "Backward rate", x=280, y=104, w=216, h=76, tint="#FFEEEE", accent="#C33A32", value_color="#B3261E"),
        ...
        _stage_card("f_stage_transition", "Stage 3 Forward Pct", "Stage 3 forward (proxy)", x=820, y=274, w=200, h=72, tint="#FFF8E6", accent="#D98A00"),
        _stage_card("f_stage_transition", "Avg Days In Stage 3", "Stage 3 avg days", x=1036, y=274, w=200, h=72, tint="#FFF8E6", accent="#D98A00"),
