...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        _stage_card("f_stage_transition", "Stage Forward Pct (LE)", "Forward % (count, L+E)", x=40, y=104, w=216, h=76, tint="#EEF9EE", accent="#3B8A3E"),
        _stage_card("f_stage_transition", "Stage Backward Pct (LE)", "Backward % (count, L+E)", x=280, y=104, w=216, h=76, tint="#FFEEEE", accent="#C33A32"),
        _stage_card("f_stage_transition", "Avg Days In Prior Stage (LE)", "Stage days (L+E)", x=520, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        _stage_card("f_opportunity", "Land Avg Sales Cycle Days", "Land cycle days", x=760, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        _stage_card("f_opportunity", "Avg Sales Cycle Days", "L+E cycle days", x=1000, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_stage_transition", "field": "Stage Forward Pct (LE)", "kind": "measure", "title": "Forward % (count, L+E)"},
                {"table": "f_stage_transition", "field": "Stage Backward Pct (LE)", "kind": "measure", "title": "Backward % (count, L+E)"},
                ...
                {"table": "f_stage_transition", "field": "Stage Moves ARR 7d", "kind": "measure", "title": "7d ARR moved (L+E)"},
            ],
            x=40,
            y=268,
            w=728,
