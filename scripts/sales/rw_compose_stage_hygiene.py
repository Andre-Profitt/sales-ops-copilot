...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        _stage_card("f_stage_transition", "Stage Forward Pct (LE)", "Forward % (count, Land + Expand)", x=40, y=104, w=216, h=76, tint="#EEF9EE", accent="#3B8A3E"),
        _stage_card("f_stage_transition", "Stage Backward Pct (LE)", "Backward % (count, Land + Expand)", x=280, y=104, w=216, h=76, tint="#FFEEEE", accent="#C33A32"),
        _stage_card("f_stage_transition", "Avg Days In Prior Stage (LE)", "Stage days (Land + Expand)", x=520, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        _stage_card("f_opportunity", "Land Avg Sales Cycle Days", "Land cycle days", x=760, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        _stage_card("f_opportunity", "Avg Sales Cycle Days", "Land + Expand cycle days", x=1000, y=104, w=216, h=76, tint="#F4F7FB", accent="#2B5C8A"),
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_stage_transition", "field": "Stage Forward Pct (LE)", "kind": "measure", "title": "Forward % (count, Land + Expand)"},
                {"table": "f_stage_transition", "field": "Stage Backward Pct (LE)", "kind": "measure", "title": "Backward % (count, Land + Expand)"},
                {"table": "f_stage_transition", "field": "Avg Days In Prior Stage (LE)", "kind": "measure", "title": "Avg days"},
                {"table": "f_stage_transition", "field": "Total Stage Transitions", "kind": "measure", "title": "Move count"},
                {"table": "f_stage_transition", "field": "Stage Moves ARR 7d", "kind": "measure", "title": "7d ARR moved (Land + Expand)"},
            ],
            x=40,
            y=268,
            w=728,
        ...
        build_table_visual(
            ...
            columns=[
                {"table": "f_stage_transition", "field": "from_stage_name", "kind": "column", "title": "Stage"},
                {"table": "f_stage_transition", "field": "Stage 4 Forward Pct", "kind": "measure", "title": "S4 Forward % (count)"},
