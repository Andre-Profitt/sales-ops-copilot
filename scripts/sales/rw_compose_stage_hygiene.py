...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        build_rag_card_visual("f_stage_transition", "Avg Days In Prior Stage (LE)", "Avg days in stage", x=640, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=None),
        build_rag_card_visual("f_stage_transition", "Total Stage Transitions", "Stage moves", x=940, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=None),
