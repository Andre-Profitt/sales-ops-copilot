    ...
    section["visualContainers"] = [
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_opportunity", "field": "Avg Deal Size Won", "kind": "measure", "title": "Avg won deal"},
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_opportunity", "field": "Closed Won Deals Count", "kind": "measure", "title": "Won deals"},
                {"table": "f_opportunity", "field": "Cross Sell To Acquired ARR", "kind": "measure", "title": "Axioma inflow"},
                {"table": "f_opportunity", "field": "SaaS YoY Growth Pct", "kind": "measure", "title": "SaaS YoY"},
                {"table": "f_opportunity", "field": "PS ARR Attach Pct", "kind": "measure", "title": "PS attach"},
            ],
            x=652,
            y=500,
            w=580,
