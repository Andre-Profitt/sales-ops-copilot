...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        build_rag_card_visual("f_opportunity", "Open Land ARR", "Open Land ARR", x=40, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=1000000),
        build_rag_card_visual("f_opportunity", "Open Expand ARR", "Open Expand ARR", x=340, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=1000000),
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_opportunity", "field": "Open Land ARR", "kind": "measure", "title": "Open Land"},
                {"table": "f_opportunity", "field": "Open Expand ARR", "kind": "measure", "title": "Open Expand"},
                {"table": "f_opportunity", "field": "Total Open Pipeline ARR", "kind": "measure", "title": "Open L+E"},
                {"table": "f_opportunity", "field": "Partner ARR", "kind": "measure", "title": "Partner ARR"},
                {"table": "f_opportunity", "field": "Partner Pct", "kind": "measure", "title": "Partner %"},
