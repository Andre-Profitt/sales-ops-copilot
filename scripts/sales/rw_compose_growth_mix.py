...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        build_rag_card_visual("f_opportunity", "Land Closed Won ARR", "Land won ARR", x=40, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=1000000),
        build_rag_card_visual("f_opportunity", "Expand Closed Won ARR", "Expand won ARR", x=340, y=104, w=280, h=76, tint="#F4F7FB", accent="#2B5C8A", value_color="#1A1D31", display_units=1000000),
        build_rag_card_visual("f_opportunity", "Partner ARR", "Partner ARR", x=640, y=104, w=280, h=76, tint="#FFF8E6", accent="#D98A00", value_color="#1A1D31", display_units=1000000),
        build_rag_card_visual("f_opportunity", "Partner Pct", "Partner %", x=940, y=104, w=280, h=76, tint="#FFF8E6", accent="#D98A00", value_color="#1A1D31", display_units=None),
        _panel(24, 224, 588, 456),
        build_textbox_visual("Land + Expand ARR by Region", x=40, y=236, w=360, h=24, font_size_pt=11, color="#1A1D31"),
        build_clustered_bar_chart_visual(
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_opportunity", "field": "Land Closed Won ARR", "kind": "measure", "title": "Land ARR"},
                {"table": "f_opportunity", "field": "Expand Closed Won ARR", "kind": "measure", "title": "Expand ARR"},
                {"table": "f_opportunity", "field": "Source ARR Won", "kind": "measure", "title": "Source ARR"},
                {"table": "f_opportunity", "field": "Source Win Rate", "kind": "measure", "title": "Source win"},
                {"table": "f_opportunity", "field": "Total Land Won Count", "kind": "measure", "title": "Land count"},
            ],
            x=652,
            y=270,
            w=580,
