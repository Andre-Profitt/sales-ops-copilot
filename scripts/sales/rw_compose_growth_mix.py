    ...
    section["visualContainers"] = [
        ...
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_opportunity", "field": "Total Open Pipeline ARR", "kind": "measure", "title": "Open ARR (Land + Expand)"},
                {"table": "f_opportunity", "field": "Avg Deal Size Won", "kind": "measure", "title": "Avg won ARR (Land + Expand)"},
