...
PAGE_KPI_CONTRACTS: dict[str, PageKPIContract] = {
    ...
    "Forecast": PageKPIContract(
        page="Forecast",
        job="Quarter answer: remaining days, open ARR, open renewal ACV, won ARR, forecast movement discipline.",
        ...
        secondary_diagnostics=("stage3_acv_value", "renewals_mom_trend"),
        kpi_ids=("forecast_closed_won", "pipeline_coverage_3x", "forecast_accuracy", "stage3_acv_value", "renewals_mom_trend"),
        measures=("Days Remaining In FQ", "Total Open Pipeline ARR", "Total Open Renewal ACV", "Total Closed Won ARR", "Forecast Slip Pct", "Forecast Slips", "Forecast Upgrades", "Avg Days In Forecast Category"),
        motion="process",
        placements=(
            p("pipeline_coverage_3x", "Total Open Pipeline ARR", "hero KPI", "land_expand_arr", "partial", "Open ARR (Land + Expand)", missing_measure="Pipeline Coverage Ratio"),
            p("renewals_mom_trend", "Total Open Renewal ACV", "hero KPI", "renewal_acv", "clean", "Open renewal ACV", secondary=True),
            p("forecast_closed_won", "Total Closed Won ARR", "hero KPI", "land_expand_arr", "clean", "Closed won ARR (Land + Expand)"),
            p("pipeline_coverage_3x", "Total Open Pipeline ARR", "variance table", "land_expand_arr", "partial", "Stage x Motion Open ARR (Land + Expand)", secondary=True, missing_measure="Pipeline Coverage Ratio"),
            p("renewals_mom_trend", "Total Open Renewal ACV", "variance table", "renewal_acv", "clean", "Stage x Motion Open renewal ACV", secondary=True),
            ...
            p("stage3_acv_value", "Total Open Pipeline ARR", "detail table", "land_expand_arr", "partial", "Late-stage open ARR (Land + Expand)", secondary=True),
            p("renewals_mom_trend", "Total Open Renewal ACV", "detail table", "renewal_acv", "clean", "Late-stage open renewal ACV", secondary=True),
        ),
    ...
    "Growth Mix": PageKPIContract(
        ...
        measures=("Open Land ARR", "Open Expand ARR", "Partner ARR", "Partner Pct", "Total Open Pipeline ARR", "Total Land Won Count", "Avg Deal Size Won", "Closed Won Deals Count", "Cross Sell To Acquired ARR", "One Off Revenues", "One-Off Revenue Opp Count", "PS ARR Attach Pct", "SaaS YoY Growth Pct", "Source ARR Won", "Source Win Rate"),
        motion="land_expand_arr",
        placements=(
            ...
            p("opp_source_effectiveness", "Source ARR Won", "variance table", "land_expand_arr", "clean", "Source ARR won (Land + Expand)", secondary=True),
            p("opp_source_effectiveness", "Source Win Rate", "variance table", "land_expand_arr", "clean", "Source win rate (count)", secondary=True),
            p("partner_opps_pct", "Partner ARR", "variance table", "land_expand_arr", "clean", "Partner ARR (Land + Expand)", secondary=True),
