...
PAGE_KPI_CONTRACTS: dict[str, PageKPIContract] = {
    ...
    "Stage Hygiene": PageKPIContract(
        ...
        placements=(
            ...
            p("stage3_approvals_compliance", "Commercial Approval Compliance Pct", "RAG card", "land_expand_arr", "clean", "Commercial Approval compliance", secondary=True),
            p("commercial_approval_to_close_time", "Commercial Approval To Close Days", "RAG card", "land_expand_arr", "clean", "Approval-to-close days", secondary=True),
        ),
    ...
    "Growth Mix": PageKPIContract(
        ...
        placements=(
            ...
            p("cross_sell_to_acquired", "Cross Sell To Acquired ARR", "detail table", "land_expand_arr", "clean", "Axioma order inflow", secondary=True),
            p("ps_arr_attach", "PS ARR Attach Pct", "detail table", "land_expand_arr", "clean", "PS attach", secondary=True),
            p("saas_arr_yoy_growth", "SaaS YoY Growth Pct", "detail table", "process", "clean", "SaaS YoY", secondary=True),
