...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        build_matrix_visual(
            ...
            values=[
                {"table": "f_opportunity", "field": "Total Open Pipeline ARR", "title": "Open ARR (L+E)"},
                {"table": "f_opportunity", "field": "Total Closed Won ARR", "title": "Won ARR (L+E)"},
