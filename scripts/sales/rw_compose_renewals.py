...
def _zebra_chart(visual: dict) -> dict:
    return tag_visual_with_zebra_transfer_metadata(
        visual,
        pattern="renewal-active-arr-risk-chart",
        visual_intent="active ARR risk by region",
    )
...
def _compose(section: dict) -> None:
    ...
    section["visualContainers"] = [
        ...
        _card("Total Open Renewal ACV", "Open ACV", x=40, accent="#D98A00"),
        _card("Total Renewal ACV Due", "Due ACV", x=214, accent="#D98A00"),
        _card("Renewal Retention Pct (Period)", "Retention", x=388, accent="#3B8A3E", value_color="#1F6F3B"),
        _card("Total Renewal ACV Won", "Won ACV", x=562, accent="#2B5C8A"),
        _card("Total Renewal ACV Lost", "Lost ACV", x=736, accent="#C33A32", value_color="#8B2C25"),
        _card("Existing ARR Run Rate", "Active ARR", measure_table="f_asset_line_item", x=910, accent="#083EA7"),
        _card("Business At Risk ARR", "Risk ARR", measure_table="f_asset_line_item", x=1084, accent="#C33A32", value_color="#8B2C25"),
        _panel(24, 224, 588, 456),
        build_textbox_visual("At-Risk Active ARR by Region", x=40, y=236, w=360, h=24, font_size_pt=11, color="#1A1D31"),
        _zebra_chart(build_clustered_bar_chart_visual(
            category_table="d_region",
            category_column="region",
            category_title="Region",
            measure_table="f_asset_line_item",
            measure_name="Business At Risk ARR",
            measure_title="At-risk active ARR",
            x=40,
            y=270,
            w=540,
            h=380,
        ...
        build_textbox_visual("Active ARR Risk Detail", x=652, y=236, w=360, h=24, font_size_pt=11, color="#1A1D31"),
        build_table_visual(
            ...
            columns=[
                ...
                {"table": "f_asset_line_item", "field": "Existing ARR Expiring In Period", "kind": "measure", "title": "Active ARR"},
                {"table": "f_asset_line_item", "field": "Business At Risk ARR", "kind": "measure", "title": "At-risk ARR"},
                {"table": "f_asset_line_item", "field": "Business At Risk Pct", "kind": "measure", "title": "Risk %"},
            ],
            x=652,
            y=270,
            w=580,
