#!/usr/bin/env python3
"""Run the browser-extension native-messaging probe on the Windows VM.

Enumerates Chrome/Edge/Firefox native-messaging host registrations,
filters for think-cell-related, reads each manifest, locates the
native host binary, and runs static analysis (version + hash + JSON
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_browser_extension.ps1"
...
def main() -> int:
    ...
    parser.add_argument("--max-binary-strings", type=int, default=1000)
    ...
    if output is None:
        ...
        output = (
            ...
            / "browser_extension"
            / stamp
            / "thinkcell_browser_extension_probe.json"
        )
