#!/usr/bin/env python3
"""Run static ETW provider / WMI namespace / perfcounter enumeration probe on the Windows VM.

Phase 12 prep only. Does NOT enable any ETW collection. Static enumeration.
"""
...
PROBE = ROOT / "scripts" / "probe_thinkcell_etw_wmi.ps1"
