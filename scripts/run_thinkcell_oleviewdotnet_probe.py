#!/usr/bin/env python3
"""Run OleViewDotNet's PowerShell-module probe against think-cell COM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_oleviewdotnet.ps1"
...
def main() -> int:
    ...
    if output_dir is None:
        ...
        output_dir = ROOT / "state" / "thinkcell_bridge" / "oleviewdotnet" / stamp
    ...
    json_path = output_dir / "thinkcell_oleviewdotnet_probe.json"
