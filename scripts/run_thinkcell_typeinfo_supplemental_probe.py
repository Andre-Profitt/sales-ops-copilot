#!/usr/bin/env python3
"""Run the typeinfo-supplemental probe (IDispatchEx + Step1/Step2 invoke)."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_typeinfo_supplemental.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / "state"
            / "thinkcell_bridge"
            / "typeinfo_supplemental"
            / stamp
            / "thinkcell_typeinfo_supplemental_probe.json"
        )
