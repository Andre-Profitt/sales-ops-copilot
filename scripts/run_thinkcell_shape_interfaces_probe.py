#!/usr/bin/env python3
"""Run the think-cell SHAPE COM-interface enumeration probe on the Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_shape_interfaces.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / "shape_interfaces"
            / stamp
            / "thinkcell_shape_interfaces_probe.json"
        )
