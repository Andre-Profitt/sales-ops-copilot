#!/usr/bin/env python3
"""Run the alternate-interfaces (QueryInterface) probe on the Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_alternate_interfaces.ps1"
...
def main() -> int:
    ...
    if output is None:
        ...
        output = (
            ...
            / stamp
            / "thinkcell_alternate_interfaces_probe.json"
        )
