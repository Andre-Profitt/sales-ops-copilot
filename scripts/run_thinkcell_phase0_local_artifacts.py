#!/usr/bin/env python3
"""Run Phase 0b local-artifact deep-read probe on the Windows VM."""
...
PROBE_PS1 = ROOT / "scripts" / "probe_thinkcell_phase0_local_artifacts.ps1"
